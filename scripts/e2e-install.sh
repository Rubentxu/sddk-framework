...
#   ./scripts/e2e-install.sh --base-url https://github.com/Rubentxu/sddk-framework/releases
...
BASE_URL="${SDDK_BASE_URL:-https://github.com/Rubentxu/sddk-framework/releases}"
