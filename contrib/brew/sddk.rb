...
class Sddk < Formula
  ...
  homepage "https://github.com/Rubentxu/sddk-framework"
  license "MIT"
  version "1.0.0"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Rubentxu/sddk-framework/releases/download/v1.0.0/sddk-darwin-arm64"
      sha256 "ee5052aed50084213d0c32686f0a8f7fcec0673c6865c3e1c7ebae0fc5a8ed8e"
    else
      odie "sddk Intel macOS binaries are not published yet (next release). Use the installer: https://raw.githubusercontent.com/Rubentxu/sddk-framework/main/scripts/install.sh"
    end
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/Rubentxu/sddk-framework/releases/download/v1.0.0/sddk-linux-aarch64"
      sha256 "5fe97bd10e7e11f7ce376d00e13e5fe6ebc8558949fbd0d658cdc831410b5cb3"
    else
      url "https://github.com/Rubentxu/sddk-framework/releases/download/v1.0.0/sddk-linux-x86_64"
