...
| `artifact_store.mode` | Yes | enum | engram, openspec, hybrid, none |
...
```json
{
  ...
  "lens_registry": "prompts/sdd-kernel/lens-registry.md",
  "skill_references": {
  ...
  "artifact_store": { "mode": "engram" },
  "artifact_references": {
    "tasks": "sddk/my-change/tasks",
    "spec": "sddk/my-change/spec",
    "design": "sddk/my-change/design"
  },
  "git_checkpoints": {
...
- `artifact_store.mode: engram` with no artifact_references for a dependent phase → BLOCKED
