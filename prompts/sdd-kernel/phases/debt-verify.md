...
- **Persisted output** is mandatory per artifact store mode (Engram, openspec, hybrid, inline for `none`).
...
- `prompts/sdd-kernel/mcw.md` — Step 2.4
- `prompts/sdd-kernel/git-contract.md` — trunk-based discipline + fix-cycle branches
