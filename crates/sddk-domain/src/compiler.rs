...
/// Exhaustive over all 10 Phase variants.
fn phase_str_to_capability(phase_str: &str) -> Option<CapabilityId> {
    match phase_str {
        ...
        "review" => Some(CapabilityId("change.review".to_string())),
...
fn phase_to_string(phase: &crate::cycle::Phase) -> String {
    match phase {
        ...
        crate::cycle::Phase::Review => "review".to_string(),
...
pub fn phase_capability(phase: crate::cycle::Phase) -> CapabilityId {
    match phase {
        ...
        crate::cycle::Phase::Review => CapabilityId("change.review".to_string()),
