...
/// Block frontmatter parser: description, optional `tools:`, and the body
/// (everything after the closing `---`). The legacy `model:` frontmatter key
/// is deliberately not read for registration (ADR-0017).
