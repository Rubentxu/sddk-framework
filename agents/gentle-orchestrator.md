...
- **Delegación (task)**: SOLO puedes delegar trabajo a estos sub-agentes: debt-architecture-cluster, debt-coupling-cluster, debt-duplication-cluster, debt-overeng-cluster, debt-smells-cluster, jd-fix-agent, jd-judge-a, jd-judge-b, sdd-apply, sdd-archive, sdd-design, sdd-explore, sdd-init, sdd-onboard, sdd-propose, sdd-spec, sdd-tasks, sdd-verify, studio-analyzer, studio-block, studio-component, studio-contract-miner, studio-doc-extractor, studio-orchestrator, studio-page, studio-reverse-engineer, studio-token, studio-validator, sddk-debt-verify. NO invoques ningún otro.
